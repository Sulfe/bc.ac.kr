   ...
   <div class="by_subject">
        <nav class="by_subject_list">
         ...
         <form class="searchbox">
            ...
            <select onchange="window.open(value, '_self');" class="subject_S_sub">
                ...
                <option value="board_language_china.jsp"selected>중국어학</option>
            </select>
            <div class="header">
                <p class="search">검색</p>
                <input class="input_search" onkeyup="filter()" type="text" id="value" placeholder="과목명 입력 : 검색버튼 없어도 검색이 됨">
              </div>
              <hr>
              <div class="container" style="overflow: auto; width: 1529px; height: 640px;">     
    
                <div class="item">
                    <span class="icon">기초</span>
                    <a href="Bu_Enrolment_board_language_china_Basic1.html" class="name">중국어입문</a>
                    <span class="professor">원정원</span>
                  </div>
          
                  <div class="item">
                    <span class="icon">기초</span>
                    <a href="Bu_Enrolment_board_language_china_Basic2.html" class="name">중국어와 중국문화</a>
                    <span class="professor">류영하</span>
                  </div>
                  
                <div class="item">
                    <span class="icon">핵심</span>
                    <a href="Bu_Enrolment_board_language_china_main1.html" class="name">중국문학개론</a>
                    <span class="professor">최경진</span>
                </div>

                <div class="item">
                    <span class="icon">핵심</span>
                    <a href="Bu_Enrolment_board_language_china_main2.html" class="name">중국어문법</a>
                    <span class="professor">이종구</span>
                </div>

                <div class="item">
                    <span class="icon">핵심</span>
                    <a href="Bu_Enrolment_board_language_china_main3.html" class="name">초급중국어회화</a>
                    <span class="professor">서해영</span>
                </div>

                <div class="item">
                    <span class="icon">심화</span>
                    <a href="Bu_Enrolment_board_language_china_deep1.html" class="name">중국문학사</a>
                    <span class="professor">최경진</span>
                </div>
                
                <div class="item">
                    <span class="icon">심화</span>
                    <a href="Bu_Enrolment_board_language_china_deep2.html" class="name">중국어학개론</a>
                    <span class="professor">이종구</span>
                </div>
                
                <div class="item">
                    <span class="icon">심화</span>
                    <a href="Bu_Enrolment_board_language_china_deep3.html" class="name">중국어작문</a>
                    <span class="professor">이종구</span>
                </div>

                <div class="item">
                    <span class="icon">응용</span>
                    <a href="Bu_Enrolment_board_language_china_applications1.html" class="name">중국어강독</a>
                    <span class="professor">최경진</span>
                </div>
                
                <div class="item">
                    <span class="icon">응용</span>
                    <a href="Bu_Enrolment_board_language_china_applications2.html" class="name">고급중국어회화</a>
                    <span class="professor">서해영</span>
                </div>
               
                <div class="item">
                    <span class="icon">응용</span>
                    <a href="Bu_Enrolment_board_language_china_applications3.html" class="name">통상실문중국어</a>
                    <span class="professor">원정원</span>
                </div>
            </div>
          </form>
