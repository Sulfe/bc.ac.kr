	...
	<div class="by_subject">
		...
		<form class="searchbox">
			<select onchange="window.open(value, '_self');" class="subject_S">
				...
				class="subject_S_sub">
				<option value="board_language.jsp" selected>전체보기</option>
				<option value="board_language_korea.jsp">국어국문학</option>
				<option value="board_language_english.jsp">영어학</option>
			...
			<div class="container"
				...
				<div class="item">
					<span class="icon">기초</span> <a
						href="Bu_Enrolment_board_language_japan_Basic1.html" class="name">일본어커뮤니케이션</a>
					<span class="professor">김현정</span>
				</div>

				<div class="item">
					<span class="icon">기초</span> <a
						href="Bu_Enrolment_board_language_china_Basic1.html" class="name">중국어입문</a>
					<span class="professor">원정원</span>
				</div>

				<div class="item">
					<span class="icon">기초</span> <a
						href="Bu_Enrolment_board_language_china_Basic2.html" class="name">중국어와
						중국문화</a> <span class="professor">류영하</span>
				</div>

				<div class="item">
					<span class="icon">핵심</span> <a
						href="Bu_Enrolment_board_language_korean_main1.jsp" class="name">현대소설의
						이해</a> <span class="professor">이혜자</span>
				</div>

				<div class="item">
					<span class="icon">핵심</span> <a
						href="Bu_Enrolment_board_language_korean_main2.html" class="name">드라마의
						이해와 실체</a> <span class="professor">이혜자</span>
				</div>
				...
				<div class="item">
					<span class="icon">핵심</span> <a
						href="Bu_Enrolment_board_language_japan_main1.html" class="name">초급
						일본어</a> <span class="professor">임성규</span>
				</div>

				<div class="item">
					<span class="icon">핵심</span> <a
						href="Bu_Enrolment_board_language_japan_main2.html" class="name">초급
						일본어 회화</a> <span class="professor">문광헌</span>
				</div>

				<div class="item">
					<span class="icon">핵심</span> <a
						href="Bu_Enrolment_board_language_japan_main3.html" class="name">일본
						한자 연습</a> <span class="professor">김현정</span>
				</div>

				<div class="item">
					<span class="icon">핵심</span> <a
						href="Bu_Enrolment_board_language_china_main1.html" class="name">중국문학개론</a>
					<span class="professor">최경진</span>
				</div>

				<div class="item">
					<span class="icon">핵심</span> <a
						href="Bu_Enrolment_board_language_china_main2.html" class="name">중국어문법</a>
					<span class="professor">이종구</span>
				</div>

				<div class="item">
					<span class="icon">핵심</span> <a
						href="Bu_Enrolment_board_language_china_main3.html" class="name">초급중국어회화</a>
					<span class="professor">서해영</span>
				</div>

				<div class="item">
					<span class="icon">심화</span> <a
						href="Bu_Enrolment_board_language_korean_deep1.html" class="name">현대시론</a>
					<span class="professor">문현미</span>
				</div>
				<div class="item">
					<span class="icon">심화</span> <a
						href="Bu_Enrolment_board_language_korean_deep2.html" class="name">고전소설의
						이해</a> <span class="professor">권도경</span>
				</div>

				<div class="item">
					<span class="icon">심화</span> <a
						href="Bu_Enrolment_board_language_korean_deep3.html" class="name">국어사</a>
					<span class="professor">박석문</span>
				</div>
				...
				<div class="item">
					<span class="icon">심화</span> <a
						href="Bu_Enrolment_board_language_japan_deep1.html" class="name">일본어
						교과 교육론</a> <span class="professor">이남희</span>
				</div>

				<div class="item">
					<span class="icon">심화</span> <a
						href="Bu_Enrolment_board_language_japan_deep2.html" class="name">일본어
						교과 교재 연구 및 지도법</a> <span class="professor">권윤경</span>
				</div>

				<div class="item">
					<span class="icon">심화</span> <a
						href="Bu_Enrolment_board_language_japan_deep3.html" class="name">일본어능력시험N2</a>
					<span class="professor">임성규</span>
				</div>

				<div class="item">
					<span class="icon">심화</span> <a
						href="Bu_Enrolment_board_language_china_deep1.html" class="name">중국문학사</a>
					<span class="professor">최경진</span>
				</div>

				<div class="item">
					<span class="icon">심화</span> <a
						href="Bu_Enrolment_board_language_china_deep2.html" class="name">중국어학개론</a>
					<span class="professor">이종구</span>
				</div>

				<div class="item">
					<span class="icon">심화</span> <a
						href="Bu_Enrolment_board_language_china_deep3.html" class="name">중국어작문</a>
					<span class="professor">이종구</span>
				</div>
				...
				<div class="item">
					<span class="icon">응용</span> <a
						href="Bu_Enrolment_board_language_japan_applications1.html"
						class="name">통상실문일본어</a> <span class="professor">문광헌</span>
				</div>

				<div class="item">
					<span class="icon">응용</span> <a
						href="Bu_Enrolment_board_language_japan_applications2.html"
						class="name">일본문학개론</a> <span class="professor">임성규</span>
				</div>

				<div class="item">
					<span class="icon">응용</span> <a
						href="Bu_Enrolment_board_language_japan_applications3.html"
						class="name">비즈니스 일본어</a> <span class="professor">김현정</span>
				</div>

				<div class="item">
					<span class="icon">응용</span> <a
						href="Bu_Enrolment_board_language_china_applications1.html"
						class="name">중국어강독</a> <span class="professor">최경진</span>
				</div>

				<div class="item">
					<span class="icon">응용</span> <a
						href="Bu_Enrolment_board_language_china_applications2.html"
						class="name">고급중국어회화</a> <span class="professor">서해영</span>
				</div>

				<div class="item">
					<span class="icon">응용</span> <a
						href="Bu_Enrolment_board_language_china_applications3.html"
						class="name">통상실문중국어</a> <span class="professor">원정원</span>
				</div>
