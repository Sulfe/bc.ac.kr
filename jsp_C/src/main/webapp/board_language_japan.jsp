        ...
        <nav class="by_subject_list">
         ...
         <form class="searchbox">
            ...
            <select onchange="window.open(value, '_self');" class="subject_S_sub">
                ...
                <option value="board_language_japan.jsp" selected>일본어학</option>
            ...
            <div class="header">
              ...
              <div class="container" style="overflow: auto; width: 1529px; height: 640px;">     
                ...
                <div class="item">
                    ...
                    <a href="Bu_Enrolment_board_language_japan_Basic1.html" class="name">일본어커뮤니케이션</a>
                    <span class="professor">김현정</span>
                  </div>

                <div class="item">
                    <span class="icon">핵심</span>
                    <a href="Bu_Enrolment_board_language_japan_main1.html" class="name">초급 일본어</a>
                    <span class="professor">임성규</span>
                </div>

                <div class="item">
                    <span class="icon">핵심</span>
                    <a href="Bu_Enrolment_board_language_japan_main2.html" class="name">초급 일본어 회화</a>
                    <span class="professor">문광헌</span>
                </div>

                <div class="item">
                    <span class="icon">핵심</span>
                    <a href="Bu_Enrolment_board_language_japan_main3.html" class="name">일본 한자 연습</a>
                    <span class="professor">김현정</span>
                </div>
                
                <div class="item">
                    <span class="icon">심화</span>
                    <a href="Bu_Enrolment_board_language_japan_deep1.html" class="name">일본어 교과 교육론</a>
                    <span class="professor">이남희</span>
                </div>
                
                <div class="item">
                    <span class="icon">심화</span>
                    <a href="Bu_Enrolment_board_language_japan_deep2.html" class="name">일본어 교과 교재 연구 및 지도법</a>
                    <span class="professor">권윤경</span>
                </div>
                
                <div class="item">
                    <span class="icon">심화</span>
                    <a href="Bu_Enrolment_board_language_japan_deep3.html" class="name">일본어능력시험N2</a>
                    <span class="professor">임성규</span>
                </div>
                
                <div class="item">
                    <span class="icon">응용</span>
                    <a href="Bu_Enrolment_board_language_japan_applications1.html" class="name">통상실문일본어</a>
                    <span class="professor">문광헌</span>
                </div>
                
                <div class="item">
                    <span class="icon">응용</span>
                    <a href="Bu_Enrolment_board_language_japan_applications2.html" class="name">일본문학개론</a>
                    <span class="professor">임성규</span>
                </div>

                <div class="item">
                    <span class="icon">응용</span>
                    <a href="Bu_Enrolment_board_language_japan_applications3.html" class="name">비즈니스 일본어</a>
                    <span class="professor">김현정</span>
                </div>
            </div>
          </form>
