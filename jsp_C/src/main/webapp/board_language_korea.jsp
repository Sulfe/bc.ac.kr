        ...
        <nav class="by_subject_list">
         ...
         <form class="searchbox">
            ...
            <select onchange="window.open(value, '_self');" class="subject_S_sub">
                ...
                <option value="board_language_korea.jsp" selected>국어국문학</option>
            ...
            <div class="header">
              ...
              <div class="container" style="overflow: auto; width: 1529px; height: 640px;">     
                <div class="item">
                    ...
                    <a href="Bu_Enrolment_board_language_korean_main1.jsp" class="name">현대소설의 이해</a>
                    <span class="professor">이혜자</span>
                  </div>
          
                  <div class="item">
                    <span class="icon">핵심</span>
                    <a href="Bu_Enrolment_board_language_korean_main2.html" class="name">드라마의 이해와 실체</a>
                    <span class="professor">이혜자</span>
                  </div>
        
                  <div class="item">
                    <span class="icon">심화</span>
                    <a href="Bu_Enrolment_board_language_korean_deep1.html" class="name">현대시론</a>
                    <span class="professor">문현미</span>
                </div>
                <div class="item">
                    <span class="icon">심화</span>
                    <a href="Bu_Enrolment_board_language_korean_deep2.html" class="name">고전소설의 이해</a>
                    <span class="professor">권도경</span>
                </div>

                <div class="item">
                    <span class="icon">심화</span>
                    <a href="Bu_Enrolment_board_language_korean_deep3.html" class="name">국어사</a>
